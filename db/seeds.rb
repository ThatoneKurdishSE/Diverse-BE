...
@obinna = User.create name: "Obinna", age: 23, email: "obinna@gjeffgolden.com", password: "password"
...
@jazzercise = Community.create name: "Jazzercise", location: "Portland, OR", description: "A large community of board game players around Seattle"
